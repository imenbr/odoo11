...
class cciCrmMailInformation(models.Model):
    ...
    def create(self, values):
        ...
        return super(cciCrmMailInformation, self).create(values)

    @api.multi
    def unlink(self):
        # cascade-delete the parent message for all mails that are not created for a notification
        to_cascade = self.search([('notification', '=', False), ('id', 'in', self.ids)]).mapped('mail_message_id')
        res = super(cciCrmMailInformation, self).unlink()
        to_cascade.unlink()
        return res
    ...
    def default_get(self, fields):
        ...
        return super(cciCrmMailInformation, self).default_get(fields)
                ...
                for email in email_list:
                    ...
                    try:
                        ...
                        if str(error) == IrMailServer.NO_VALID_RECIPIENT:
                            ...
                            _logger.info("Ignoring invalid recipients for mail.information %s: %s",
